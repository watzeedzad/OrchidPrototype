...
export default class EdirProject{
    ...
    async operation(req,res){
        ...
        await editProjectData(id,tribeName,isAutoFertilizering,currentRatio);
...
async function editProjectData(id,tribeName,picturePath,isAutoFertilizering,currentRatio){
